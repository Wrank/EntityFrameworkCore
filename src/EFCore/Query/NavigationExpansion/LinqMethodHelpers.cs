...
namespace Microsoft.EntityFrameworkCore.Query.NavigationExpansion
{
    public static class LinqMethodHelpers
    {
        ...
        public static MethodInfo AsEnumerable { get; private set; }
        ...
        static LinqMethodHelpers()
        {
            ...
            AsEnumerable = enumerableMethods.Where(m => m.Name == nameof(Enumerable.AsEnumerable) && m.IsGenericMethod).Single();
